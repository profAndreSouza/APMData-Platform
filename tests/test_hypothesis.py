import pytest
import numpy as np
from app.core.hypothesis import (
    teste_shapiro_wilk,
    teste_kolmogorov_smirnov,
    teste_qui_quadrado_associacao
)
...
def test_teste_shapiro_wilk_normal():
    ...
    est, p_val, e_normal = teste_shapiro_wilk(valores)
...
def test_teste_qui_quadrado_associacao():
    ...
    est, p_val, ha_associacao = teste_qui_quadrado_associacao(tabela)
